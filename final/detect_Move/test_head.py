...
def face_detect():
    ...
    cv2.imwrite('result_face.jpg',image)
    #cv2.imshow('face_detection',buff)
    #im=Image.frombuffer(buff)
    #im.show()
    return faces
...
##                                serialArduino.write(b'w') #Body Move Left
##                                serialArduino.readline()  #Read The executed Command from arduino
##                                time.sleep(2)
##                                serialArduino.write(b'x') #stop
##                                serialArduino.readline()  #Read The executed Command from arduino
...
##                                serialArduino.write(b'w') #Body Move Right
##                                serialArduino.readline()  #Read The executed Command from arduino
##                                time.sleep(6)
##                                serialArduino.write(b'x') #stop
##                                serialArduino.readline()  #Read The executed Command from arduino
...
##                                
                                ...
                                serialArduino.write(b'x') #stop
                                serialArduino.readline()  #Read The executed Command from arduino 
                                faces_arr=face_detect()
                                print(len(faces_arr))
                                if(len(faces_arr)>0):
                                  speak_call("A person is detected")
                                  speak_call("Hi there")
                                  speak_call("How are you today?")
                                ...
                                serialArduino.write(b'r') #Head Move left
                                serialArduino.readline()  #Read The executed Command from arduino
                                time.sleep(2.5)
                                serialArduino.write(b'x') #stop
                                serialArduino.readline()  #Read The executed Command from arduino
                                ...
                                camera.capture(img_name,'jpeg')
                                speak_call("In my Right there is a")
                                human_string_rt=detect(sess,softmax_tensor,img_name,graph_time)
                                #print(human_string_rt)
                                #espeak.synth(human_string_rt)
                                #Move head to center position and stop right after 2.5 secs
                                serialArduino.write(b'l') #Head Move right
                                serialArduino.readline()  #Read The executed Command from arduino
                                time.sleep(2.2)
                                serialArduino.write(b'x') #stop
                                serialArduino.readline()  #Read The executed Command from arduino
